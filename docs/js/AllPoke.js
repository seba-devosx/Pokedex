                    ...
                    <div class="row justify-content-center" >
                      <div id="pokemon-data" style="background-color:${x} ">
                          ...
                          <div id="contenedor-img-poke" class="col-8 mt-2">
                            ...
                            <h4 id="id-poke" class="text-center text-capitalize text-white"style="background-color:${x} ">${typec}</h4>
                            <h6 id="id-poke"class="text-center text-capitalize text-white">#${id_poke}</h6>
                          </div>
                          </div>
                      </div>
                   </div>`;
           
        document.getElementById('pokemonAllDiv').appendChild(pokemon);
